...
public class Kasir {
    ...
    public void tambahPelanggan(int nomorMeja, Pelanggan pelanggan) {
        if(daftarMeja[nomorMeja - 1].isKosong()){
            daftarMeja[nomorMeja - 1].setNomorMeja(nomorMeja);
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    int nomorMejaTP =  scanner.nextInt();
                    System.out.print("Nama Pelanggan: ");
                    String namaPelanggan = scanner.next();
                    tambahPelanggan(nomorMejaTP, new Pelanggan(namaPelanggan));
                    break;
                case 3:
                ...
                case 6:
                    ...
                    Boolean mejaKosong = daftarMeja[nomorMejaTampil - 1].isKosong();
                    if (mejaKosong) {
